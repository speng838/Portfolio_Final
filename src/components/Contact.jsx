...
class Contact extends Component {
    ...
    handleForm = e => {
        let that = this;
        axios
            .post("https://formcarry.com/s/za0krSGHU2Q-", this.state, {
...
Contact.defaultProps = {
    ...
    sectionDescription: "Feel free to contact me by using the information on the right. Otherwise go ahead and message me down below to the left.",
    AddTitle: "Address",
    Address: "9569 Pine Meadows Ln Burke Virginia 22015",
    EmailTitle: "Email",
    Email: "speng838@yahoo.com",
    PhoneTitle: "Phone",
    Phone: "(202)-839-0102",
};
