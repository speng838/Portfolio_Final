                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-5 col-md-5">
                            <div className="social-icons">
                                <ul className="list-inline">
                                    <li><a href={this.props.facebookLink} rel="noopener noreferrer" target="_blank"><Icofont icon="icofont-github" /></a></li>
                                    <li><a href={this.props.twitterLink} rel="noopener noreferrer" target="_blank"><Icofont icon="icofont-linkedin" /></a></li>
                                    <li><a href={this.props.instagramLink} rel="noopener noreferrer" target="_blank"><Icofont icon="icofont-paper" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
NavBar.defaultProps = {
    ...
    mailLink: "mailto:speng838@yahoo.com",
    mail: "speng838@yahoo.com ",
    numberLink: "callto:+2028390102",
    Number: "+2028390102",
    facebookLink: "/github",
    twitterLink: "/linkedin",
    instagramLink: "/resume",
};
